...
public class Registration {
  ...
  private final Set<SubscriberFilter> subscriberFilters;
  ...
  public Registration(
                  ...
                  @JsonProperty("subscriber_filters") Set<SubscriberFilter> subscriberFilters) {
    this.id = id;
    this.name = name;
  ...
  public Set<SubscriberFilter> getSubscriberFilters() {return subscriberFilters;}
  ...
  @Override public int hashCode() {
    return Objects.hash(self, journalUrl, traceUrl, id, name, description, clientId,
            registrationId, deliveryType, webhookStatus, createdDate, updatedDate,
            consumerId, projectId, workspaceId, webhookUrl, runtimeAction, enabled,
            eventsOfInterests, subscriberFilters);
  }
